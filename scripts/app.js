...
clearButton_1.addEventListener("click", function (event) {
  ...
  canvas_client.style.pointerEvents = "auto";
    ...
    axios({
      ...
      .then(res => {
        ...
        if (res.data == "sucesso") {
          ...
          // const popup = document.querySelector(".popup-container"); // vai ser aberto no final do form
          // popup.classList.add("mostrar");

          savePNGButton_1.style.opacity = ".5";
          savePNGButton_1.style.pointerEvents = "none";
          canvas_client.style.pointerEvents = "none";
