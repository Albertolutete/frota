			...
			<div class="row">
				...
				<div class="col-3">
					<select class="form-select" aria-label="Default select example" aria-placeholder="">
						...
						<option value="3"> aguardando Tecnico</option>
						<option value="3"> aguardando Aprovação de orçamento</option>
					</select>
				</div>
				<div class="col-3">
					<select class="form-select" aria-label="Default select example">
						<option selected>Ambulâcia</option>
		...
		<div class="card-content">
			<table class="table">
				...
				<tbody>
					<tr>
						<td scope="row"></td>
						<td data-label="Aguardando Resgate" scope="row">Ambulância</td>
					</tr>
					<tr>
						<td scope="row"></td>
					...
					<tr>
						<td scope="row"></td>
						<td data-label="Aguardando Resgate" scope="row">Ônibus</td>
					</tr>
				</tbody>
			</table>
		</div>
