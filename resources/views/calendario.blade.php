		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="addEvent" name="addEvent" method="post" data-postattempt="0">
					...
					<?php if(App\Empresa::find(Auth::user()->empresa_id)->tipo == "principal"): ?>
					<div class="mb-3 row">
						...
						<div class="col-sm-10">
							<select class="form-control" id="tecnico" name="tecnico_id" required>
							    ...
							    <?php foreach(App\Empresa::find(Auth::user()->empresa_id)->tecnicos as $tecnico): ?>
...
function tecnicos(){
return $this->hasMany(App\tecnico::class, "prestadora_id");
}
