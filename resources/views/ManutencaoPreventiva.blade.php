		...
		<div class="row mb-2">
			...
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item active">Manutenção Preventiva</li>
				</ol>
			</div>
		</div>
	</div><!-- /.container-fluid -->
						...
						<tbody>
							...
							<?php foreach ($manutec as $man): ?>
								...
								<tr>
									...
									<td><img src="{{ asset('sign/' . $man->assinaturaTecnico) }}" alt=""
										width="150px" height="50px">
									</td>
									<td>{{ $man->created_at }}</td>

									<td><a href="{{ Route('imprimir', base64_encode($man->id)) }}" target="_blank">
										Imprimir</a></td>
									</tr>
